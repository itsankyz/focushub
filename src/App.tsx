    ...
    try {
      ...
      if (sale.customerId && sale.customerId !== 'new-customer') {
        setCustomers((prev) =>
          prev.map((customer) => {
            ...
            return {
              ...
              latestFrameName: frameItem?.name || customer.latestFrameName,
              latestFrameCost: frameItem?.total || customer.latestFrameCost,
              latestLensName: lensItem?.name || customer.latestLensName,
              latestLensCost: lensItem?.total || customer.latestLensCost,
        ...
        const newCustomer: Customer = {
          ...
          latestFrameName: frameItem?.name,
          latestFrameCost: frameItem?.total,
          latestLensName: lensItem?.name,
          latestLensCost: lensItem?.total,
          latestOrderTotal: sale.total,
        };
